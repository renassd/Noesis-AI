...
export const DICT = {
  en: {
    nav: { home: "Home", research: "Research", study: "Study", howItWorks: "How it works", openApp: "Use Noesis" },
    landing: {
      eyebrow: "Research flows + memory tools",
      headline: "Noesis connects understanding and remembering.",
      ...
      proofResearchDesc: "Find papers, summarise evidence, generate literature reviews and structure academic reports.",
      ...
      featuresSub: "Most students juggle one tool to understand and another to memorise. Noesis connects both sides so you go from question to ready-to-review deck without switching tabs.",
      ...
      workflowSub: "Instead of reading a paper in one app and building flashcards in another, Noesis keeps your research and review in the same place.",
      step1title: "1. Ask or upload material",
      step1: "Start with a research question, a paper, your class notes or a full lecture PDF.",
      ...
      pricingSub: "The research assistant you already use costs more than Noesis and does not help you remember anything.",
      waitlistEyebrow: "Early access",
      waitlistTitle: "Understand first. Remember after.\nBoth in one place.",
      waitlistSub: "Noesis is not just another flashcard app or another AI research assistant. It is the layer that connects understanding, synthesis and memory, built for students and researchers.",
    ...
    pricing: [
      ...
      { label: "Noesis", price: "All in one", desc: "Research, explanation, tutoring and flashcards in one connected flow.", items: ["Ask, understand, remember", "Research to review without switching apps", "Built for students and academic researchers"], featured: true },
    ],
    study: {
      pageTitle: "Study",
      ...
      noDecksDesc: "Generate flashcards from the left panel and save your first deck to start reviewing.",
      pickDeckTitle: "Review flashcards",
      pickDeckDesc: "Choose a deck to start studying.",
      cardOf: "Card {current} of {total}",
      answered: "{n} answered",
      sessionDone: "Session complete",
      sessionDoneDesc: "You reviewed {total} cards from {deck}.",
      easy: "Easy",
      hard: "Hard",
      wrong: "Need review",
      reviewAgain: "Review again",
      // TutorMode
      tutorTitle: "Tutor mode",
      tutorDesc: "Type the topic you want to learn and Noesis will explain it step by step, checking your understanding at each stage.",
      tutorPlaceholder: "E.g. photosynthesis, Bayes theorem, the immune system...",
      tutorStart: "Start session ->",
      tutorNewTopic: "New topic",
      tutorHeader: "Tutor mode",
      tutorSubheader: "Answer the tutor's questions to advance through the topic.",
      tutorExamples: ["Basic quantum mechanics", "Behavioral economics", "The immune system", "Machine Learning"],
      // MyDecks
      myDecksTitle: "My decks",
      loadingDecks: "Loading decks",
      loadingDecksDesc: "Fetching your saved decks.",
      noSavedDecks: "No saved decks",
      noSavedDecksDesc: "Generate flashcards with AI and save your first deck for it to appear here.",
      deckSaved: "Save",
      deckEdit: "Edit",
      deckReview: "Review ->",
      deckDelete: "Delete",
  ...
  es: {
    nav: { home: "Inicio", research: "Investigacion", study: "Estudio", howItWorks: "Como funciona", openApp: "Usar Noesis" },
    landing: {
      eyebrow: "Flujos de investigacion + herramientas de memoria",
      headline: "Noesis conecta el entendimiento y el recuerdo.",
      ...
      proofResearchDesc: "Encontra papers, resume evidencia, genera revisiones de literatura y estructura reportes academicos.",
      ...
      featuresSub: "La mayoria de los estudiantes usa una herramienta para entender y otra para memorizar. Noesis conecta los dos lados.",
      ...
      workflowSub: "En lugar de leer un paper en una app y construir flashcards en otra, Noesis mantiene tu investigacion y tu repaso en el mismo lugar.",
      step1title: "1. Pregunta o sube material",
      step1: "Empieza con una pregunta de investigacion, un paper, tus apuntes de clase o un PDF completo.",
      ...
      pricingSub: "El asistente de investigacion que ya usas cuesta mas que Noesis y no te ayuda a recordar nada.",
      waitlistEyebrow: "Acceso anticipado",
      waitlistTitle: "Entiende primero. Recuerda despues.\nLas dos cosas en un solo lugar.",
      waitlistSub: "Noesis no es solo otra app de flashcards ni otro asistente de investigacion con IA. Es la capa que conecta comprension, sintesis y memoria.",
    ...
    pricing: [
      ...
      { label: "Herramientas de flashcards", price: "$30/anio", desc: "Flujo de flashcards independiente.", items: ["Excelente para la repeticion espaciada", "Ayuda de investigacion muy limitada", "Creacion manual de tarjetas para la mayoria"] },
      { label: "Noesis", price: "Todo en uno", desc: "Investigacion, explicacion, tutoria y flashcards en un flujo conectado.", items: ["Pregunta, entiende y recuerda", "De la investigacion al repaso sin cambiar de app", "Hecho para estudiantes e investigadores"], featured: true },
    ],
    study: {
      pageTitle: "Estudio",
      generate: "Generar flashcards",
      review: "Repasar flashcards",
      tutor: "Modo tutor",
      decks: "Mis mazos",
      ...
      // FlashcardStudy
      noDecksTitle: "No tenes mazos todavia",
      noDecksDesc: "Genera flashcards desde el panel de la izquierda y guarda tu primer mazo para empezar a repasar.",
      pickDeckTitle: "Repasar flashcards",
      pickDeckDesc: "Elegi un mazo para empezar a estudiar.",
      cardOf: "Tarjeta {current} de {total}",
      answered: "{n} respondidas",
      sessionDone: "Sesion completada",
      sessionDoneDesc: "Repasaste {total} tarjetas del mazo {deck}.",
      easy: "Facil",
      hard: "Dificil",
      wrong: "A repasar",
      reviewAgain: "Volver a repasar",
      // TutorMode
      tutorTitle: "Modo tutor",
      tutorDesc: "Escribe el tema que quieres aprender y Noesis te va a explicar paso a paso, verificando tu comprension en cada etapa.",
      tutorPlaceholder: "Ej: fotosintesis, teorema de Bayes, sistema inmune...",
      tutorStart: "Empezar sesion ->",
      tutorNewTopic: "Nuevo tema",
      tutorHeader: "Modo tutor",
      tutorSubheader: "Responde las preguntas del tutor para avanzar en el tema.",
      tutorExamples: ["Mecanica cuantica basica", "Economia conductual", "El sistema inmune", "Machine Learning"],
      // MyDecks
      myDecksTitle: "Mis mazos",
      loadingDecks: "Cargando mazos",
      loadingDecksDesc: "Estamos trayendo tus decks guardados.",
      noSavedDecks: "No tenes mazos guardados",
      noSavedDecksDesc: "Genera flashcards con IA y guarda tu primer mazo para que aparezca aca.",
      deckSaved: "Guardar",
      deckEdit: "Editar",
      deckReview: "Repasar ->",
      deckDelete: "Eliminar",
