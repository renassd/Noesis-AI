...
export const DICT = {
  en: {
    ...
    landing: {
      ...
      missionBody: "Knowledge shouldn't be a privilege. Neuvra transforms complex information into something people can genuinely learn, remember, and act on — not just skim and forget. We believe that when deep understanding becomes accessible, people ask better questions, make better decisions, and leave things a little better than they found them.",
      whoWeAreTitle: "Who We Are",
      whoWeAreBody: "Neuvra is a learning platform built around how humans actually come to understand things — through synthesis, connection, and memory that sticks. We built it for students who need more than a summary, and researchers who need more than a search engine. It's not a chatbot. It's not a note-taking app. It's a system for real, lasting understanding.",
  ...
  es: {
    ...
    landing: {
      ...
      missionBody: "El conocimiento no deberia ser un privilegio. Neuvra transforma informacion compleja en algo que las personas pueden aprender de verdad, recordar y aplicar — no solo leer y olvidar. Creemos que cuando la comprension profunda se vuelve accesible, las personas hacen mejores preguntas, toman mejores decisiones y dejan el mundo un poco mejor de como lo encontraron.",
      whoWeAreTitle: "Quienes Somos",
      whoWeAreBody: "Neuvra es una plataforma de aprendizaje disenada en torno a como las personas realmente llegan a entender algo: a traves de la sintesis, la conexion y una memoria que permanece. La construimos para estudiantes que necesitan mas que un resumen, y para investigadores que necesitan mas que un buscador. No es un chatbot. No es una app de notas. Es un sistema para una comprension real y duradera.",
