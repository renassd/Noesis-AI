  ...
  return (
    <>
        ...
        <div className="wrap">
          ...
          <div className="nav-group">
            <nav className="nav">
              ...
              <Link href="/investigacion" className="nav-page-link">Investigacion</Link>
              <Link href="/estudio" className="nav-page-link">Estudio</Link>
      ...
      <main id="home">
        ...
        {/* Embedded workspace (quick access) */}
        <section id="workspace-live">
          <div className="wrap">
            <div className="section-header reveal">
              <div>
                <h2>Probalo ahora mismo.</h2>
                <p>
                  El workspace funcional esta embebido abajo. O usa las paginas independientes para una
                  experiencia mas enfocada:{" "}
                  <Link href="/investigacion" style={{ color: "var(--blue-700)", fontWeight: 600 }}>Investigacion</Link>
                  {" "}y{" "}
                  <Link href="/estudio" style={{ color: "var(--blue-700)", fontWeight: 600 }}>Estudio</Link>.
                </p>
              </div>
